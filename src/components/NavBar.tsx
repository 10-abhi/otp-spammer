 ...
 export const Navbar = ()=>{
      return <div className=" bg-slate-900 h-20 w-full  flex justify-around  font-bold text-2xl items-center px-2 py-2">
         <div className=" from-slate-600 to-cyan-900 bg-gradient-to-r bg-clip-text text-transparent space-x-4"> {"<OTP SPAMMER/>"} </div>  
         <span className="[&>svg]:h-10 [&>svg]:w-7 [&>svg]:fill-[#046b7f]">
